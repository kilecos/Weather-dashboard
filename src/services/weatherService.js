...
export async function getMeteo(latitude, longitude) {
    ...
    const response = await fetch(
        ...
        + `&current=temperature_2m,apparent_temperature,windspeed_10m,winddirection_10m,relativehumidity_2m,weathercode,precipitation_probability,pressure_msl,is_day`
        + `&daily=temperature_2m_max,temperature_2m_min,weathercode,precipitation_probability_mean,sunrise,sunset,daylight_duration,uv_index_max`
